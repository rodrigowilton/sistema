...
urlpatterns = [
    ...
    path("controleacesso/", include("controleacesso.urls")),
    path("solicitacaoimagem/", include("solicitacaoimagem.urls")),
    path("solicitacaoaudio/", include("solicitacaoaudio.urls")),
    path("appmorador/", include("appmorador.urls")),
]
