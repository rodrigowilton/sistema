...
from .views import (home, editar_condominio, consultar_condominio, excluir_condominio, register, lista_autenticacao,
                    configuracao, manage_groups, manage_users_groups_permissions, add_group, edit_group_permissions, delete_group)
...
urlpatterns = [
    ...
    path('grupos/adicionar/', add_group, name='add_group'),
